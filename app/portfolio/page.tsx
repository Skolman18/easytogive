...
function getAllColor(index: number, defaults: PortfolioAllocation[]) {
  return defaults[index]?.color ?? EXTRA_COLORS[index % EXTRA_COLORS.length];
}
    ...
    <div style={{ backgroundColor: "#faf9f6" }} className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid lg:grid-cols-3 gap-8">
            ...
            >
              {isValid ? (
                ...
                <AlertCircle
                  ...
                  style={{ color: totalPercent > 100 ? "#dc2626" : "#ea580c" }}
                />
              )}
          ...
          {/* Right: Donut chart + donation amount */}
            ...
            >
              ...
              <div className="grid grid-cols-3 gap-2 mb-4">
                ...
                <button
                  ...
                  className={`py-2 rounded-lg text-sm font-semibold transition-all ${
                    useCustom ? "text-white" : "text-gray-700 hover:text-gray-900"
                  }`}
                  style={
                    useCustom
                      ? { backgroundColor: "#1a7a4a" }
              ...
              {/* Summary */}
              <div className="space-y-1.5 mb-5 pt-3 border-t" style={{ borderColor: "#f0ede6" }}>
                {allocations
                  .filter((a) => a.percentage > 0)
                  .map((a) => (
                    <div key={a.orgId} className="flex items-center justify-between text-sm">
                      <span className="text-gray-600 truncate mr-2">{a.orgName}</span>
              ...
              {/* Donate button */}
              <button
                disabled={!isValid || effectiveAmount <= 0}
